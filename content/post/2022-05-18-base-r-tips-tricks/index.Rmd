...
tricks that I have found to be useful.
...
We can use these sample files as an example for explorinf some base R functionality.
...
matching the pattern from each filepath.
...
dataframe to include the sample name.
